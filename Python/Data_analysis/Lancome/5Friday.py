# -*- coding:utf8 -*-
# author：Fitz.Xu
# file function: Friday files empty writen
...
output_onlined10 = u'\u0031\u004f\u006e\u006c\u0069\u006e\u0065\u8d2d\u4e70\u65e5\u7b2c\u5341\u5929'
output_jiangji_heika = '2' + u'\u964d\u7ea7\u63d0\u9192\u002d\u9ed1\u91d1\u5361'
output_jiangji_jinka = '3' + u'\u964d\u7ea7\u63d0\u9192\u002d\u91d1\u5361'
output_jiangji_yinka1 = '4' + u'\u964d\u7ea7\u63d0\u9192\u002d\u94f6\u5361\u002d\u53ea\u6d88\u8d39\u8fc7\u4e00\u6b21'
output_jiangji_yinka0 = '5' + u'\u964d\u7ea7\u63d0\u9192\u002d\u94f6\u5361\u002d\u672a\u6d88\u8d39\u8fc7'
output_newjoind3 = u'\u0036\u65b0\u5165\u4f1a\u4eba\u5458\u63d0\u9192'
...
file_flag_newjoin_heika = u'\u9ed1\u91d1\u5361\u4f1a\u5458'
file_flag_newjoin_heikaxuhui = u'\u9ed1\u91d1\u5361\u7eed\u4f1a\u0026\u964d\u7ea7\u53c8\u5347\u7ea7'
file_flag_newjoin_yinkaxuhui = u'\u94f6\u5361\u7eed\u4f1a\u0026\u964d\u7ea7\u53c8\u5347\u7ea7'
...
#1Online购买日第十天
writer_onlined10 = pd.ExcelWriter(path + file_current_name + '\\' + output_onlined10 + '-' + file_current_name + '.xlsx')
data1.to_excel(writer_onlined10, sheet_name = file_flag_TMALL, columns = None, header=False, index = False, encoding = 'utf-8-sig')
data1.to_excel(writer_onlined10, sheet_name = file_flag_EC, columns = None, header=False, index = False, encoding = 'utf-8-sig')
writer_onlined10.save()
n = n + 1
...
#6新入会D3
writer_newjoind3 = pd.ExcelWriter(path + file_current_name + '\\' + output_newjoind3 + '-' + file_current_name + '.xlsx')
data1.to_excel(writer_newjoind3, sheet_name = file_flag_newjoin_heika, columns = None, header=False, index = False, encoding = 'utf-8-sig')
data2.to_excel(writer_newjoind3, sheet_name = file_flag_newjoin_heikaxuhui, columns = None, header=False, index = False, encoding = 'utf-8-sig')
data3.to_excel(writer_newjoind3, sheet_name = file_flag_newjoin_yinkaxuhui, columns = None, header=False, index = False, encoding = 'utf-8-sig')
writer_newjoind3.save()
n = n + 1
...
print 'Files of Friday All Finished!'