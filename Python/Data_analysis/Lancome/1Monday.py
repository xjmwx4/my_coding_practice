# -*- coding:utf8 -*-
# author：Fitz.Xu
# file function: Monday files empty writen
...
file_flag_heika = u'\u9ed1\u91d1\u5361\u4f1a\u5458'
file_flag_heikaxuhui = u'\u9ed1\u91d1\u5361\u7eed\u4f1a\u0026\u964d\u7ea7\u53c8\u5347\u7ea7'
file_flag_yinkaxuhui = u'\u94f6\u5361\u7eed\u4f1a\u0026\u964d\u7ea7\u53c8\u5347\u7ea7'
...
data1.to_excel(writer_newjoind3, sheet_name = file_flag_heika, columns = None, header=False, index = False, encoding = 'utf-8-sig')
data2.to_excel(writer_newjoind3, sheet_name = file_flag_heikaxuhui, columns = None, header=False, index = False, encoding = 'utf-8-sig')
data3.to_excel(writer_newjoind3, sheet_name = file_flag_yinkaxuhui, columns = None, header=False, index = False, encoding = 'utf-8-sig')
...
print 'Files of Monday All Finished!'